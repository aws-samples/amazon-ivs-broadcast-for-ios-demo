...
class DeviceDataUsage {
    ...
    public static var dataUsed: Int {
        let wifiUsage = getDataUsage().wifiSent + getDataUsage().wifiReceived
        let cellUsage = getDataUsage().wirelessWanDataSent + getDataUsage().wirelessWanDataReceived

        return Int(max(wifiUsage, cellUsage))
    }
